...
<p><i><b>Name:</b></i> <span contenteditable="true">${name}</span></p>
<p><b><i>Email:</b></i> <span contenteditable="true">${email}</span></p>
<p><i><b>Phone:</b></i> <span contenteditable="true">${phone}</span></p>
<h3><i>Education</i></h3>
